...
describe('PlayerSaverService', () => {
	...
	let playerSaver: PlayerSaverService;
	let mockStore: any;
	...
	it('should create PlayerSaver instance with provided store', async () => {
		moduleRef = await Test.createTestingModule({
			providers: [PlayerSaverService, { provide: PlayerStore, useValue: mockStore }]
		}).compile();

		playerSaver = moduleRef.get<PlayerSaverService>(PlayerSaverService);
		expect(playerSaver).toBeInstanceOf(PlayerSaverService);
	});

	it('should create PlayerSaver instance with null store', async () => {
		moduleRef = await Test.createTestingModule({
			providers: [PlayerSaverService, { provide: PlayerStore, useValue: null }]
		}).compile();
	...
	it('should create PlayerSaverService instance with undefined store', async () => {
		moduleRef = await Test.createTestingModule({
			providers: [PlayerSaverService, { provide: PlayerStore, useValue: undefined }]
		}).compile();
